...
export declare const protocols: {
    data: GetUriProtocol<import("./data.js").DataOptions>;
    file: GetUriProtocol<import("./file.js").FileOptions>;
    ftp: GetUriProtocol<import("./ftp.js").FTPOptions>;
    http: GetUriProtocol<import("./http.js").HttpOptions>;
    https: GetUriProtocol<import("./http.js").HttpOptions>;
};
