...
import { t as require_src } from "./src-DeJ8xfEM.js";
import { n as fromStream, r as fromBuffer, t as fromFile } from "./lib-2uGInEX0.js";
import { n as TrackType, r as TrackTypeValueToKeyMap } from "./types-BYI5fCsw.js";
import { C as UINT32_LE, a as UnsupportedFileTypeError, i as InternalParserError, k as textDecode, n as CouldNotDetermineFileTypeError } from "./BasicParser-DVL-5j-c.js";
import { l as toRatio, n as decodeString } from "./Util-BpLYh0Gp.js";
import { c as TimestampFormat, i as LyricsContentType } from "./ID3v2Token-De-8_RRk.js";
import { t as APEv2Parser } from "./APEv2Parser-bKsLdrRm.js";
import { r as hasID3v1Header } from "./ID3v1Parser-D7tX8HB0.js";
...
const mpegParserLoader = {
	...
	async load() {
		return (await import("./MpegParser-WCZ-vrKd.js")).MpegParser;
	}
};
//#endregion
...
const apeParserLoader = {
	...
	async load() {
		return (await import("./APEv2Parser-D7AJVTS4.js")).APEv2Parser;
	}
};
//#endregion
...
const asfParserLoader = {
	...
	async load() {
		return (await import("./AsfParser-BwDtNu-o.js")).AsfParser;
	}
};
//#endregion
...
const dsdiffParserLoader = {
	...
	async load() {
		return (await import("./DsdiffParser-DJ6BLhdP.js")).DsdiffParser;
	}
};
//#endregion
...
const aiffParserLoader = {
	...
	async load() {
		return (await import("./AiffParser-BtZe9mG9.js")).AIFFParser;
	}
};
//#endregion
...
const dsfParserLoader = {
	...
	mimeTypes: ["audio/dsf"],
	async load() {
		return (await import("./DsfParser-BhuPbB5d.js")).DsfParser;
	}
};
//#endregion
...
const flacParserLoader = {
	...
	async load() {
		return (await import("./FlacParser-D1hYae9h.js")).FlacParser;
	}
};
//#endregion
...
const matroskaParserLoader = {
	...
	async load() {
		return (await import("./MatroskaParser-CnK6OMjQ.js")).MatroskaParser;
	}
};
//#endregion
...
const mp4ParserLoader = {
	...
	async load() {
		return (await import("./MP4Parser-DfvQ3mtZ.js")).MP4Parser;
	}
};
//#endregion
...
const musepackParserLoader = {
	...
	async load() {
		return (await import("./MusepackParser-C7i1w-kX.js")).MusepackParser;
	}
};
//#endregion
...
const oggParserLoader = {
	...
	async load() {
		return (await import("./OggParser-DInwhVbZ.js")).OggParser;
	}
};
//#endregion
...
const wavpackParserLoader = {
	...
	async load() {
		return (await import("./WavPackParser-DugD5LmZ.js")).WavPackParser;
	}
};
//#endregion
...
const riffParserLoader = {
	...
	async load() {
		return (await import("./WaveParser-DGM1mrfV.js")).WaveParser;
	}
};
//#endregion
