...
import { r as getActivePluginRegistry } from "./runtime-D85K4f41.js";
...
import { i as hasNonEmptyString } from "./channel-target-BYsT_Fvn.js";
import { t as hasPotentialConfiguredChannels } from "./config-presence-DX3v0oFJ.js";
import { i as normalizeTrustedSafeBinDirs, o as listRiskyConfiguredSafeBins } from "./exec-safe-bin-trust-Bwqa9cfY.js";
import { n as formatPermissionRemediation, r as inspectPathPermissions, t as formatPermissionDetail } from "./audit-fs-VQxNy-Kx.js";
import { t as formatCliCommand } from "./command-format-QzcL7Uge.js";
import { o as resolveGatewayAuth } from "./auth-_BXr3UsJ.js";
import { n as resolveSandboxConfigForAgent } from "./config-BDl7wzWk.js";
import { V as isInterpreterLikeAllowlistPattern, l as loadExecApprovals } from "./exec-approvals-cQLfKLyM.js";
import { i as resolveMergedSafeBinProfileFixtures, n as listInterpreterLikeSafeBins } from "./exec-safe-bin-runtime-policy-1veJRSeE.js";
import { n as collectEnabledInsecureOrDangerousFlags, t as DEFAULT_GATEWAY_HTTP_TOOL_DENY } from "./dangerous-tools-BOUfypwG.js";
import path from "node:path";
import { isIP } from "node:net";
//#region src/security/audit-deep-code-safety.ts
let auditDeepModulePromise;
async function loadAuditDeepModule() {
	auditDeepModulePromise ??= import("./audit.deep.runtime-Yo4dO_nf.js");
...
async function loadChannelPlugins() {
	channelPluginsModulePromise ??= import("./plugins-CD71-66u.js");
	return await channelPluginsModulePromise;
}
async function loadAuditNonDeepModule() {
	auditNonDeepModulePromise ??= import("./audit.nondeep.runtime-CxzzUH-6.js");
	return await auditNonDeepModulePromise;
}
async function loadAuditChannelModule() {
	auditChannelModulePromise ??= import("./audit-channel.collect.runtime-vrehDK4u.js");
	return await auditChannelModulePromise;
}
async function loadPluginRegistryLoaderModule() {
	pluginRegistryLoaderModulePromise ??= import("./runtime-registry-loader-10muduKP.js");
	return await pluginRegistryLoaderModulePromise;
}
async function loadPluginMetadataRegistryLoaderModule() {
	pluginMetadataRegistryLoaderModulePromise ??= import("./metadata-registry-loader-DPTr9Qkt.js");
...
async function loadGatewayProbeDeps() {
	gatewayProbeDepsPromise ??= Promise.all([
		import("./call-BEBL0XX-.js"),
		import("./probe-auth-4d9LeGM1.js"),
		import("./probe-CcMn588A.js")
