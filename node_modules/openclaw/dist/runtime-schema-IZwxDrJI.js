...
import { t as CHANNEL_IDS } from "./ids-DLKhAFnj.js";
...
import { m as resolveDefaultAgentId, p as resolveAgentWorkspaceDir } from "./agent-scope-BoZcgjP9.js";
import { D as GENERATED_BUNDLED_CHANNEL_CONFIG_METADATA, E as collectPluginSchemaMetadata, T as collectChannelSchemaMetadata, c as loadConfig, f as readConfigFileSnapshot } from "./config-nRyLQtXB.js";
import "./zod-schema.sensitive-Bb2iPiXZ.js";
import { a as redactSensitiveUrlLikeString, n as hasSensitiveUrlHintTag, r as isSensitiveUrlConfigPath, t as SENSITIVE_URL_HINT_TAG } from "./redact-sensitive-url-BYHNjhXn.js";
					...
					ssrfPolicy: {
						...
						properties: {
							dangerouslyAllowPrivateNetwork: {
								...
								description: "Allows access to private-network address ranges from browser tooling. Default is enabled for trusted-network operator setups; disable to enforce strict public-only resolution checks."
							},
							allowedHostnames: {
								type: "array",
								items: { type: "string" },
						...
						additionalProperties: {
							...
							properties: {
								...
								request: {
									...
									description: "Optional request overrides for model-provider requests, including extra headers, auth overrides, proxy routing, and TLS client settings. Use these only when your upstream or enterprise network path requires transport customization."
								},
								models: {
									type: "array",
									items: {
				...
				properties: {
					defaults: {
						...
						properties: {
							...
							embeddedPi: {
								type: "object",
								properties: { projectSettingsPolicy: {
									anyOf: [
										{
											type: "string",
											const: "trusted"
				...
				properties: {
					...
					experimental: {
						...
						properties: { planTool: {
							...
							description: "Enable or disable the experimental structured `update_plan` tool for non-trivial multi-step work tracking. OpenAI and OpenAI Codex runs auto-enable it when this flag is unset; set false to disable that auto-enable."
						} },
						additionalProperties: false,
