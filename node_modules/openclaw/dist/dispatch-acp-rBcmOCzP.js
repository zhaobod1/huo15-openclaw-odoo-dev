...
import { a as generateSecureUuid } from "./secure-random-CzkBLb2F.js";
import { s as hasOutboundReplyContent } from "./reply-payload-CcbNO0Ax.js";
import { n as formatToolSummary, r as resolveToolDisplay } from "./tool-display-CA6V7nEQ.js";
import { i as emitAgentEvent } from "./agent-events-CQXvdh_Z.js";
import { i as toAcpRuntimeError } from "./errors-BMY0gYhU.js";
import { o as isSessionIdentityPending, u as resolveSessionIdentityFromMeta } from "./session-identity-CTfydB_j.js";
import { n as resolveAcpAgentPolicyError, r as resolveAcpDispatchPolicyError } from "./policy-DzGFE76H.js";
import { r as resolveAcpThreadSessionDetailLines } from "./session-identifiers-vntVmClF.js";
import { r as prefixSystemMessage } from "./system-message-kky0VnJG.js";
import { t as EmbeddedBlockChunker } from "./pi-embedded-block-chunker-DtX8rr5U.js";
import { t as resolveConfiguredTtsMode } from "./tts-config-BFVSDv6e.js";
import { r as resolveEffectiveBlockStreamingConfig, t as clampPositiveInteger } from "./block-streaming-BRdxX5IY.js";
import { t as formatAcpRuntimeErrorText } from "./error-text-BlKg4TDz.js";
import { r as createBlockReplyPipeline } from "./block-reply-pipeline-Cey1SNwN.js";
import { t as resolveStatusTtsSnapshot } from "./status-config-B9mZ9axU.js";
...
function loadDispatchAcpMediaRuntime() {
	dispatchAcpMediaRuntimePromise ??= import("./dispatch-acp-media.runtime-Brt9coJf.js");
...
function loadRouteReplyRuntime() {
	routeReplyRuntimePromise ??= import("./route-reply.runtime-CsTTk0U9.js");
	return routeReplyRuntimePromise;
}
function loadDispatchAcpTtsRuntime$1() {
	dispatchAcpTtsRuntimePromise$1 ??= import("./dispatch-acp-tts.runtime-DcM703w-.js");
	return dispatchAcpTtsRuntimePromise$1;
}
function loadChannelPluginRuntime() {
	channelPluginRuntimePromise ??= import("./plugins-CD71-66u.js");
	return channelPluginRuntimePromise;
}
function loadMessageActionRuntime() {
	messageActionRuntimePromise ??= import("./message-action-runner-DCLut5R_.js");
...
function loadDispatchAcpManagerRuntime() {
	dispatchAcpManagerRuntimePromise ??= import("./dispatch-acp-manager.runtime-CVttGfkU.js");
	return dispatchAcpManagerRuntimePromise;
}
function loadDispatchAcpSessionRuntime() {
	dispatchAcpSessionRuntimePromise ??= import("./dispatch-acp-session.runtime-BsOakWfS.js");
	return dispatchAcpSessionRuntimePromise;
}
function loadDispatchAcpTtsRuntime() {
	dispatchAcpTtsRuntimePromise ??= import("./dispatch-acp-tts.runtime-DcM703w-.js");
