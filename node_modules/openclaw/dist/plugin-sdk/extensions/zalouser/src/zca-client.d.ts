import { LoginQRCallbackEventType, Reactions, TextStyle, ThreadType, type Style } from "./zca-constants.js";
...
export type API = {
    ...
    sendMessage(message: string | Record<string, unknown>, threadId: string, type?: number): Promise<{
        msgId?: string | number;
        message?: {
            msgId?: string | number;
        } | null;
    ...
    uploadAttachment(sources: string | {
        data: Buffer;
    ...
    }>, threadId: string, type?: number): Promise<Array<{
    ...
    sendVoice(options: {
        voiceUrl: string;
        ttl?: number;
    }, threadId: string, type?: number): Promise<{
        msgId?: string | number;
    }>;
    sendLink(payload: {
        link: string;
    ...
    sendTypingEvent(threadId: string, type?: number, destType?: number): Promise<{
        status: number;
    }>;
...
type ZaloCtor = new (options?: {
    ...
    loginQR(options?: {
        ...
        language?: string;
        qrPath?: string;
    }, callback?: (event: LoginQRCallbackEvent) => unknown): Promise<API>;
};
export declare function createZalo(options?: ConstructorParameters<ZaloCtor>[0]): Promise<InstanceType<ZaloCtor>>;
