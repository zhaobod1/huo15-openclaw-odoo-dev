...
export declare class BlockedBrowserTargetError extends Error {
    constructor();
}
...
export declare function assertPageNavigationCompletedSafely(opts: {
    cdpUrl: string;
    page: Page;
...
export declare function gotoPageWithNavigationGuard(opts: {
    cdpUrl: string;
    page: Page;
    url: string;
    timeoutMs: number;
