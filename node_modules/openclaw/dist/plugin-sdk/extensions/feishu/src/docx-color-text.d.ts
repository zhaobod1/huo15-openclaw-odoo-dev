 ...
 */
export declare function parseColorMarkup(content: string): Segment[];
/**
 * Update a text block with colored segments.
 */
export declare function updateColorText(client: Lark.Client, docToken: string, blockId: string, content: string): Promise<{
    success: boolean;
    segments: number;
    block: {
