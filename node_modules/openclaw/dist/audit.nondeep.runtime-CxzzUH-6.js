...
import { n as isDangerousNetworkMode, r as normalizeNetworkMode } from "./network-mode-BbKfVlrZ.js";
import { t as formatCliCommand } from "./command-format-QzcL7Uge.js";
import { o as resolveGatewayAuth } from "./auth-_BXr3UsJ.js";
import { n as resolveSandboxConfigForAgent, o as resolveSandboxToolPolicyForAgent } from "./config-BDl7wzWk.js";
import { u as resolveToolProfilePolicy } from "./tool-policy-CTDyMWRb.js";
import { r as pickSandboxToolPolicy, t as isToolAllowedByPolicies } from "./tool-policy-match-Cxnn6-3p.js";
import { i as resolveNodeCommandAllowlist, t as DEFAULT_DANGEROUS_NODE_COMMANDS } from "./node-command-policy-aaayhviG.js";
import { t as resolvePluginWebSearchProviders } from "./web-search-providers.runtime-BdKr4ayk.js";
import { u as getBlockedBindReason } from "./docker-DnAihzPd.js";
import { t as inferParamBFromIdOrName } from "./model-param-b-gyJUfAm-.js";
import { t as resolveAllowedAgentIds } from "./hooks-policy-Cw6SfFY5.js";
import { a as collectSandboxBrowserHashLabelFindings, c as readConfigSnapshotForAudit, i as collectPluginsTrustFindings, o as collectStateDeepFilesystemFindings, s as collectWorkspaceSkillSymlinkEscapeFindings, t as collectIncludeFilePermFindings } from "./audit-extra.async-C3q68KMW.js";
...
function collectSandboxDangerousConfigFindings(cfg) {
	...
	if (defaultBrowser.enabled && normalizeOptionalLowercaseString(defaultBrowser.network) === "bridge" && !defaultBrowser.cdpSourceRange?.trim()) browserExposurePaths.push("agents.defaults.sandbox.browser");
	for (const entry of agents) {
		if (!entry || typeof entry !== "object" || typeof entry.id !== "string") continue;
		const browser = resolveSandboxConfigForAgent(cfg, entry.id).browser;
		if (!browser.enabled) continue;
		if (normalizeOptionalLowercaseString(browser.network) !== "bridge") continue;
