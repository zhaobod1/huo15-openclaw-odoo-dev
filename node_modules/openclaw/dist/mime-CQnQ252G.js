...
function getFileExtension(filePath) {
	...
	try {
		if (/^https?:\/\//i.test(filePath)) {
			...
			return normalizeLowercaseStringOrEmpty(path.extname(url.pathname)) || void 0;
		}
	} catch {}
	return normalizeLowercaseStringOrEmpty(path.extname(filePath)) || void 0;
}
...
function isGifMedia(opts) {
	if (normalizeOptionalLowercaseString(opts.contentType) === "image/gif") return true;
